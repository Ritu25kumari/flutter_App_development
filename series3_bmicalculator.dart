...
class _BmiCalculatorState extends State<BmiCalculator> {
  ...
  Calculate_Bmi(){
    ...
    print(BMI);
    setState(() {
      calcalated_bmi.text = BMI.toStringAsFixed(2);
      if(BMI<16){
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(
        ...
        children: [
        SizedBox(height: 100,),
          Center(child: Text('BMI Calculator',style: TextStyle(fontWeight: FontWeight.bold,color: Colors.blue[900],fontSize: 25))),
          SizedBox(height: 20,),
          Padding(
          ...
          Text('BMI :'+ calcalated_bmi.text,style: TextStyle(fontSize: 18,fontWeight: FontWeight.bold,color: Colors.blue[900]),)
      ],),
    );
  }
}
